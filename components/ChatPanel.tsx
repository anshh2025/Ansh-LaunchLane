...
export function ChatPanel({
  ...
  return (
    <div className="flex w-[320px] shrink-0 flex-col bg-[#030b07] border-r border-emerald-900/30">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-emerald-900/30 px-2 py-3">
